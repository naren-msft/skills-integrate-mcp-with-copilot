document.addEventListener("DOMContentLoaded", () => {
  ...
  // Helper to categorize activities (simple mapping for demo)
  ...
  function renderActivities() {
    ...
    if (sort === "name") {
      ...
      filtered.sort(([, a], [, b]) => (a.max_participants - a.participants.length) - (b.max_participants - b.participants.length));
    }
  ...
  // Add filter/sort/search listeners
